...
public class Buy implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Enter.theValue(userLoombokData.getFirstName()).into(SerenityBuy.TXT_FirstName),
                Enter.theValue(userLoombokData.getLastName()).into(SerenityBuy.TXT_LastName),
                Enter.theValue(userLoombokData.getPostalCode()).into(SerenityBuy.TXT_Zip),
